...
function Strategy(options, verify) {
  ...
  options.customHeaders = new Buffer($CLIENT_ID + ":" + $CLIENT_SECRET).toString('base64');
...
Strategy.prototype.authorizationParams = function (options) {
  console.log('authorizationParams called');
  console.log(options);
 ...
 *
 *   - `provider`         always set to `Yahoo JAPAN`
